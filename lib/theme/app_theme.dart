...
class AppTheme {
  ...
  // Trusted Clarity Palette - Colors optimized for financial interfaces
  static const Color primaryLight = Color(0xFF2B5CE6);
  static const Color primaryVariantLight = Color(0xFF1E3A8A);
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Headline styles - Inter with weights for financial data scanning
      ...
      // Body styles - Inter for readability during extended use
